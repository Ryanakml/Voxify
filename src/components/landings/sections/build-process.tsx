...
const leftSteps: Step[] = [
    {
        ...
        description:
            "Pick the perfect voice based on your goal: product demo, narration, support, social content, or branded campaigns.",
    },
    {
        title: "Generate, Review, and Export",
        description:
            "Create your audio in seconds, review the output, and export clean files ready for production and publishing.",
    },
];
...
const rightSteps: Step[] = [
    {
        ...
        description:
            "Add your text, adjust pacing and style, and turn raw ideas into polished voice-ready scripts quickly.",
    },
    {
        title: "Tune the Delivery",
        description:
            "Control tone, clarity, and emotion so every line sounds natural and aligned with your brand voice.",
    },
];
    ...
    return (
        <section id="process" className="flex flex-col items-center mt-32">
            ...
            <h3 className="text-3xl max-w-sm text-gray-500 text-center mt-5">
                Produce Pro-Level Voice Content in Four Steps
            </h3>
